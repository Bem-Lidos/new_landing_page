...
const linkClass =
  'text-purple-600 dark:text-purple-400 hover:underline underline-offset-2'
  ...
  return (
    <div className='min-h-screen bg-white dark:bg-gray-900'>
      ...
      <main className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16'>
        <article className='text-gray-700 dark:text-gray-300 space-y-6 text-sm md:text-base leading-relaxed'>
          <h1 className='text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white'>
            Política de Privacidade
          </h1>

          <p>
            A sua privacidade é importante para nós. É política do BemLidos
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site{' '}
            <a
              href='https://bemlidos.com.br'
              className={linkClass}
              target='_blank'
          ...
          <p>
            ...
            informação que o BemLidos oferece no site e com caráter enunciativo,
            mas não limitativo:
          </p>
          ...
          <ul className='list-disc pl-5 space-y-3'>
            ...
            <li>
              ...
              (softwares) do BemLidos, de seus fornecedores ou terceiros, para
          ...
          <p className='text-gray-600 dark:text-gray-400'>
            Esta política é efetiva a partir de 9 de maio de 2026, 22:41.
          </p>
        </article>
      </main>
      <Footer />
